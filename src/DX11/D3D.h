...
namespace dx11
{
	...
	public:
		...
		*/
		D3D(int screenWidth, int screenHeight, HWND hwnd, bool fullscreen, float screenDepth, float screenNear);
		~D3D();
		...
		DirectX::XMMATRIX getProjectionMatrix();	///< Returns default projection matrix
		DirectX::XMMATRIX getWorldMatrix();		///< Returns identity world matrix
		DirectX::XMMATRIX getOrthoMatrix();		///< Returns default orthographic matrix
		...
		ID3D11RenderTargetView* RenderTargetView() { return renderTargetView; }
		ID3D11DepthStencilView* DepthTargetView() { return depthStencilView; }
	...
	protected:
		...
		DirectX::XMMATRIX projectionMatrix;					///< Identity projection matrix
		DirectX::XMMATRIX worldMatrix;						///< Identity world matrix
		DirectX::XMMATRIX orthoMatrix;						///< Identity orthographic matrix
