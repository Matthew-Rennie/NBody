...
dx11::DX11VertexBuffer<dx11::VertexType>* MeshBuilder::CubeMesh(dx11::DX11Renderer* renderer)
{
	using namespace DirectX;

	auto vbuffer = new dx11::DX11VertexBuffer<dx11::VertexType>();
	...
	renderer->get_d3d()->getDevice()->CreateBuffer(&vertexBufferDesc, &vertexData, &vertexBuffer);
	...
	renderer->get_d3d()->getDevice()->CreateBuffer(&indexBufferDesc, &indexData, &indexBuffer);
	...
	*vbuffer->pVertexBuffer() = vertexBuffer;
	*vbuffer->pIndexBuffer() = indexBuffer;
	vbuffer->VertexCount() = vertexCount;
	vbuffer->IndexCount() = indexCount;
